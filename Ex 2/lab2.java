...
public class lab2{
    ...
    System.out.println("2-Search for a name you entered");
    System.out.println("3-Remove a name you entered");
    ...
    System.out.println("This name already exist, please give another name");
    } else {
    names[count++] = name;
    ...
    System.out.print("Enter name to be searched for: ");
    String name = sc.next();
